...
const Search = (props) => {
  ...
  return (
    <View>
      ...
      <View style={{height: useWindowDimensions().height,backgroundColor: '#fff'}}>
          ...
          >
            <Card.Title
              ...
              left={(props) => (
                <Avatar.Image
                  size={50}
                  source={item.profilePicUrl ? {uri: item.profilePicUrl} : require("../../assets/defaultProfilePic.png")}
                />
              )}
              right={(props) => <IconButton {...props} color={Colors.grey500} icon="chevron-right"  />}
            />
          </TouchableOpacity>
